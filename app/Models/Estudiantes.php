...
class Estudiantes extends Model
{
    ...
    'id_direccion','id_nacionalidad','id_tiposangre','padecimiento','discapacidad','regular','semestre','estatus','creditos_acumulados','id_lenguaindigena','id_puebloindigena','clave_grupo','id'];
